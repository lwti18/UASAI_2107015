...
<table width="700" border="0" cellpadding="2" cellspacing="1" align="center">
  <tr align="center">
    <td colspan="3"><strong>Input Data Penyakit</strong></td>
  </tr>
  <tr>
...
<table id="tabel" width="100%" cellpadding="3" cellspacing="0" border="1" align="center">
  ...
  <tr valign="baseline">
    ...
    <td><a title="Edit Penyakit" href="edpenyakit.php?kdubah=<?php echo $data['kd_penyakit'];?>"><img src="image/edit.jpg" width="16" height="16" border="0"></a></td>
    <td><a title="Hapus Penyakit" style="cursor:pointer;" onclick="return konfirmasi('<?php echo $data['kd_penyakit'];?>');"><img src="image/hapus.jpg" width="16" height="16" ></a>
    </td>
  </tr>
  <?php
  } ?>
