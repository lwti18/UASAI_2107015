...
$cf_p=$_POST['idcf'];
$queryDel=mysql_query("DELETE  FROM relasi WHERE kd_penyakit='$kd_penyakit' ");
...
for ($start=0; $start < count($text_line); $start++) {
	...
	$sqlCekRelasi=mysql_query("SELECT * FROM ");
	$sql="INSERT INTO  relasi (kd_gejala,kd_penyakit,cf_p) VALUES ('$baris','$kd_penyakit','$cf_p')";
