...
<head>
    ...
    <title>Registrasi Pemakai</title>
    ...
    <div class="art-sheet">
        ...
        <div class="art-sheet-body">
            <div class="art-header">
                ...
                <div class="art-logo">
                                 <h1 class="art-logo-name"><a href="index.php">Sistem Pakar Pendeteksi Penyakit Diabetes Melitus</a></h1>
                                 <h2 class="art-logo-text">Sistem Pakar Pendeteksi Penyakit DM Menggunakan Metode Certainty factor (CF)</h2>
                                </div>
            </div>
